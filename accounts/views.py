...
# from.forms import StaffUserCreationForm, UserAccountRegistrationForm
...
#     message = render_to_string('front/accounts/mail.html', {
#         'user': user.full_name,
...
#         return render (request, 'front/accounts/register.html', {'form':form})
...
#             return render ( request, 'front/accounts/register.html', {'form':form, 'submitted': True})
...
#         form = StaffUserCreationForm(instance=user)
#         return render (request, 'staff/detail_staff.html', {'form':form , 'user':user, 'edit':True, 'profile':True})
    
#     def post(self, request, id): 
        
#         user= UserAccount.objects.get(id=id)
#         form = StaffUserCreationForm(instance=user, data=self.request.POST, files=self.request.FILES )
...
#         if user is not None:
#             login(request, user)        
#             messages.success(request, f'welcome back to Delta')
#             return redirect("/")
    
#         else:
#             messages.warning(request, 'Email or password is wrong!',)
#             return render(request, 'front/accounts/login.html', {'form':form})
...
# #     password = request.POST.get('password')
# #     email = request.POST.get('email')
# #     user = UserAccount.objects.create( email = email, password = password)
# #     send_email(user)
